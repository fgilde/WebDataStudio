...
public sealed class PostgreSqlDriver : IDbDriver
{
    public DriverInfo Info { get; } = new("postgresql", "PostgreSQL", 5432, "Host=localhost;Port=5432;Database=postgres;Username=postgres;Password=");
